...
** the posts
- [[file:djosm.html][(d)josm or how i spent several hours with virtual keyboards]]
- [[file:ideapad.html][ubuntu on an ideapad flex 5]]
- [[file:personal-train-tracking.html][me tracking my train routes]]
- [[file:org-fit.html][another bizarre attempt at tracking when i go outside (in org mode)]]
- [[file:grime.html][me talking about grime music]]
- [[file:archive-ontology/index.html][the ontology for my personal archives]] (outdated)
- [[file:me][contact data via rdf/turtle!!!]]
- [[file:referentialtransparency.html][a couple weaker notions of referential transparency]]
- [[file:button.html][the button (making a usb button work on linux)]]
- [[https://uniw.university/bourbakilean-docs/index.html][bourbaki book lean docs]]
- [[file:cohomology.html][homology stuff idk!!!]]
- [[file:books.html][books i read]]
- [[file:beyond.html][thoughts beyond]]
- [[file:music.html][music and the future]]
